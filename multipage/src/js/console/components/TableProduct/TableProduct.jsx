...
import TableProduct_css from './TableProduct.css'
...
function Hoc(WrappedComponent) {
    return class extends React.Component {
        ...
        cellEdit_options = {
            ...
            blurToSave: true,
            autoSelectText: true,
            //beforeSaveCell: (oldValue, newValue, row, column) => {  }, // a hook for before saving cell
            afterSaveCell: (oldValue, newValue, row, column) => {
                ...
                //console.log('afterSaveCell--- ', productId, newObject)
